...
> [!NOTE]
> This permission applies to the app that opens the APK, such as your browser or file manager. Managed-device policies or Android Advanced Protection may block installation from external sources completely.
