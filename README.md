...
- Explicitly activated, packaged Node.js 24.18.0, npm 11.19.0, and Python 3.14.6 toolchains
...
The current release line is **0.4.9** for **Android 10+** on **ARM64**. Host tests and APK integrity gates cover the protocol, storage, native supervisor, toolchains, signing, and architecture boundaries. Installation and device-specific UI, lifecycle, and long-running behavior are validated separately on a physical test device.
